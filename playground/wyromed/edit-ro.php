...
<html lang="en">
    <head>
        ...
        <title>Edit Receive Order | Wyromed</title>
    </head>
    <body>
        <div class="appWrap">
            ...
            <div class="row">
                <div class="col-3">
                    <h5><i class="fas fa-sign-in-alt green-brand"></i> Edit Receive Order</h5><br/>
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <input type="text" class="form-control" value="Mnf001">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="form-row">
                                                <div class="col-4">
                                                    ...
                                                    <input type="text" class="form-control" value="DO-001">
                                                </div>
                                                <div class="col-4">
                                                    <label for="noTelp">Lokasi</label>
                                                    <select id="top" class="form-control select2">
                                                        <option>-- Pilih Lokasi --</option>
                                                        <option selected>Rak A</option>
                                                        <option>Rak B</option>
                                                    </select>
                                                </div>
                                                <div class="col-4">
                                    ...
                                    <table id="datatables" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>0</td>
                                                <td>44,444</td>
                                                <td class="text-center"><a href="" data-toggle="modal" data-target="#modal-confirm-delete" ><i class="far fa-trash-alt"></i></a> &nbsp <a href="#" data-toggle="modal" data-target="#modal-ro-item-product"><i class="far fa-edit"></i></a></td>
                                            </tr>
                                            <tr>
                                                <td>KANEBO_02</td>
                                                <td>Kanebo</td>
