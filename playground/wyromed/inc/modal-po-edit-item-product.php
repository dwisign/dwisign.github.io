<div class="modal fade" id="modal-po-edit-item-product" tabindex="-1" role="dialog" aria-labelledby="modal-po-edit-item-product" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-md" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="modal-po-edit-item-product">Edit Item Product</h5>
                ...
                <div class="form-group">
                    <div class="form-row">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" value="Chetaphil Gentle 500 ml">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="form-row">
                        <div class="col-6">
                            ...
                            <input type="text" class="form-control" value="M-01">
                        </div>
                        <div class="col-6">
                            <label>Satuan</label>
