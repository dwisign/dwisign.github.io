<div class="modal fade" id="modal-so-create" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalCenterTitle">Sales Order</h5>
      ...
      <div class="modal-footer">
        <a href="add-so.php" type="button" class="btn btn-primary">Simpan</a>
