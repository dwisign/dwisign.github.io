<div class="modal fade" id="modal-stock-entry-edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      ...
      <div class="modal-body">
        <form>
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="Cetaphil Kids  ">
            </div>
            <div class="form-group">
                <div class="form-row">
                    <div class="col-6">
            ...
            <div class="form-group">
                <div class="form-row">
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control" value="4321">
                    </div>
                    <div class="col-6">
                        <label for="noTelp">Kadaluarsa</label>
                        <input type="text" class="form-control" id="expired_date_2" value="18/06/2021">
                    </div>
                </div>
            </div>
            <div class="form-group">
