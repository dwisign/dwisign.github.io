...
<head>
    ...
    <title>Edit Data Customer | Wyromed</title>
</head>
...
<body>
    <div class="appWrap">
        ...
        <div class="content-wrap container">
            <div class="row">
                <div class="col-3">
                    <h5><i class="fas fa-notes-medical"></i> Edit Data Customer</h5><br />
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="text-right">
                                <a href="list-data-customer.php" type="button" class="btn btn-outline-warning"><i class="fas fa-list"></i> List Customer</a>
                            </div>
                        </div>
                    </div>
                    <div class="content">
                            ...
                            <div class="col-md-10 offset-md-1">
                                <form>
                                    <div class="form-group">
                                        <div class="form-row">
                                            <div class="col">
                                                <label for="namaRS">Nama Customer</label>
                                                <input type="text" class="form-control" value="Rumah Sakit Pondok Indah">
                                            </div>
                                            <div class="col">
                                    ...
                                    <div class="text-right">
                                        <br /><br /><br /><br /><a href="list-data-customer.php" type="button" class="btn btn-outline-success">Save</a>
                                    </div>
                                </form>
                            </div>
                        </div>
