...
<html lang="en">
    <head>
        ...
        <title>Edit Sales Order | Wyromed</title>
    </head>
    <body>
        <div class="appWrap">
            ...
            <div class="row">
                <div class="col-3">
                    <h5><i class="fas fa-sign-in-alt green-brand"></i> Edit Sales Order</h5><br/>
                                                ...
                                                <div class="form-group">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col-4">
                                                            ...
                                                            <select id="term-payment" class="form-control select2">
                                                ...
                                                <div class="form-group">
                                                    <div class="form-row">
                                                        <div class="col-4">
                                                            ...
                                                            <input type="text" class="form-control" id="so_end_date" value="10/05/2018">
                                                        </div>
                                                        <div class="col-4">
                                                        ...
                                                        <div class="col-4">
                                                            ...
                                                            <select id="sales-status" class="form-control select2">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" value="1350000" disabled>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="noTelp">Total Discount (Rp)</label>
                                                            <input type="text" class="form-control" value="270000" disabled>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="noTelp">PPN (Rp)</label>
                                                            <input type="text" class="form-control" value="135000" disabled>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="noTelp">Grand Total (Rp)</label>
                                                            <input type="text" class="form-control" value="1485000" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                <br/>
