...
<head>
    ...
    <title>Edit Data User | Wyromed</title>
</head>
...
<body>
    <div class="appWrap">
        ...
        <div class="content-wrap container">
            <div class="row">
                <div class="col-3">
                    <h5><i class="fas fa-notes-medical"></i> Edit Data User</h5><br />
                    ...
                    <div class="row">
                        ...
                        <div class="col-8">
                            <div class="text-right">
                                <a href="list-data-user.php" type="button" class="btn btn-outline-warning"><i class="fas fa-list"></i> List User</a>
                            </div>
                        </div>
                    </div>
                    <div class="content">
