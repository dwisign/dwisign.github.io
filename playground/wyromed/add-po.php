...
<html lang="en">
    <head>
        ...
        <title>Create Purchase Order | Wyromed</title>
    </head>
    <body>
        <div class="appWrap">
            ...
            <div class="row">
                <div class="col-3">
                    <h5><i class="fas fa-sign-in-alt green-brand"></i> Create Purchase Order</h5><br/>
                                        ...
                                        <div class="form-group">
                                            <div class="form-row">
                                                ...
                                                <div class="col-4">
                                                    ...
                                                    <input type="text" class="form-control" id="po_order_date">
                                                </div>
                                                <div class="col-4">
                                                    <label for="noTelp">Tanggal Berakhir PO</label>
                                                    <input type="text" class="form-control" id="po_end_date">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
