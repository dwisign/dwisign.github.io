				...
				<div class="container content-inside">
					...
					<div class="tab-content col-sm-8 my-acc-right">
					  <div class="tab-pane active" id="acc">
					  		...
					  		<form class="form-horizontal left-label col-padding10-L" role="form">

							  <div class="form-group">
							    <label for="inputName" class="col-sm-4 control-label">Name*</label>
							    <div class="col-sm-8">
							      <p>Fani Puspitasari</p>
							    </div>
							  </div>
							  ...
							  <div class="form-group">
							    ...
							    <div class="col-sm-8">
							      <p>Jl. Kasasi 2 Blok C5 No.7 Rt.004 Rw. 013 Komp.<br>Pengayoman Tangerang</p>
							    </div>
							  </div>
							  ...
							  <div class="form-group">
							    <div class="col-sm-8">
							      <a href="my-account-unfill.php" class="btn btn-danger-2 btn-block">Ubah</a>
							    </div>
