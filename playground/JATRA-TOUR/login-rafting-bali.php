						...
						<div class="row">
							<div class="col-sm-8 left col-padding50-R border-right">
								...
								<div class="form-group">
				             	...
				             	<div class="form-group align-right">
									...
									<a href="rafting-payment-confirm-bali.php"><button type="submit" class="btn btn-ribbon">Login</button></a>
								</div>
								...
								<div class="form-group">
				             	...
				             	<div class="form-group align-right">
									<a href="rafting-payment-confirm-bali.php"><button type="submit" class="btn btn-ribbon">Submit</button></a>
								</div>
							...
							<div class="col-sm-3">
								<div class="cart">
									...
									<h5>Price</h5>
									<hr>	
									<h5>IDR 1.800.000 (Per Dewasa)</h5>
