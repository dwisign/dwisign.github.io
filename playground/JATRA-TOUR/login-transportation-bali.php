						...
						<div class="row">
							<div class="col-sm-8 left col-padding50-R border-right">
								...
								<div class="form-group">
				             	...
				             	<div class="form-group align-right">
									...
									<a href="transportation-payment-confirm-bali.php"><button type="submit" class="btn btn-ribbon">Login</button></a>
								</div>
								...
								<div class="form-group">
				             	...
				             	<div class="form-group align-right">
									<a href="transportation-payment-confirm-bali.php"><button type="submit" class="btn btn-ribbon">Submit</button></a>
								</div>
							...
							<div class="col-sm-3">
								<div class="cart">
									...
									<h5>Pick Up</h5>
									<hr>
									<p>Tue, 06 May 2014 | 07:00 PM</p>
									
									<br>

									<h5>Drop Off</h5>
									<hr>
									<p>Wed, 10 May 2014 | 07:00 PM</p>
									
									<br>

									<h5>Amount of Cars</h5>
									<hr>
									<p>2</p>
