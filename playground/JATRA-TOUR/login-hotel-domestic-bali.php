							...
							<div class="col-sm-8 left col-padding50-R border-right">
								...
								<div class="form-group">
				             	...
				             	<div class="form-group align-right">
									...
									<a href="hotel-domestic-payment-confirm-bali.php"><button type="submit" class="btn btn-ribbon">Login</button></a>
								</div>
								...
								<div class="form-group">
				             	...
				             	<div class="form-group align-right">
									<a href="hotel-domestic-payment-confirm-bali.php"><button type="submit" class="btn btn-ribbon">Submit</button></a>
								</div>
