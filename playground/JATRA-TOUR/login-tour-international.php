						...
						<div class="row">
							<div class="col-sm-8 left col-padding50-R border-right">
								...
								<div class="form-group">
				             	...
				             	<div class="form-group align-right">
									...
									<a href="tour-payment-international-confirm.php"><button type="submit" class="btn btn-ribbon">Login</button></a>
								</div>
								...
								<div class="form-group">
				             	...
				             	<div class="form-group align-right">
									<a href="tour-payment-international-confirm.php"><button type="submit" class="btn btn-ribbon">Submit</button></a>
								</div>
							...
							<div class="col-sm-3">
								<div class="cart">
									...
									<h5>Date</h5>
									<hr>
									<p>Tue, 06 May 2014 - Wed, 10 May 2014</p>
