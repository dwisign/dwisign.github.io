						...
						<div class="row">
							<div class="col-sm-8 left col-padding50-R border-right">
								...
								<div class="form-group">
				             	...
				             	<div class="form-group align-right">
									...
									<a href="star-cruise-payment-confirm.php"><button type="submit" class="btn btn-ribbon">Login</button></a>
								</div>
								...
								<div class="form-group">
				             	...
				             	<div class="form-group align-right">
									<a href="star-cruise-payment-confirm.php"><button type="submit" class="btn btn-ribbon">Submit</button></a>
								</div>
							...
							<div class="col-sm-3">
								<div class="cart">
									...
									<h5>Cruise Name</h5>
									<hr>
									<p>Super Star Virgo</p>

									<br>

									<h5>Location</h5>
									<hr>
									<p>3D/2N Superstar Gemini Wednesday Singapore Pulau Tioman Cruising</p>
