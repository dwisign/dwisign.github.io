							  ...
							  <div class="panel-body">
		                                    ...
		                                    <div class="form-group">  	
										      <div class="col-xs-10">  
										        <div class="checkbox">
										          <label>
										            <input type="checkbox"> Saya telah membaca dan memahami <a href="info-spbu.php">persyaratan</a> dan <a href="prosedur.php">prosedur</a> pengajuan pendirian SPBU.
										          </label>
										        </div>
										      </div>
										    </div> 
									...
									<ul class="pager">
									  <li class="previous"><a href="daftar-spbu-1.php">← Prev</a></li>
									  <li class="next"><a href="daftar-spbu-2-success.php">Next →</a></li>
									</ul>
