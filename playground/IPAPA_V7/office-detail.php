...
<html lang="en">
  <head>
    <title>IPAPA V.7 | Office Detail</title>
    <?php
  ...
  <body>
    ...
    <div id="officeBanner">
      <div class="officeBannerTitle">
        <h3 class="title-2">South Quarter <span class="label_premium"><img src="img/premium-icon.png" width="30" alt="premium" title="premium"></span></h3>
      ...
      <div class="row">
        <div class="col-sm-8 officeBannerLeft">
          <a class="fancybox zoom" href="img/nobel-house.jpg">
            <div class="imgOfficeBanner" style="background: url('img/nobel-house.jpg')"></div>
          </a>
        </div>
    ...
    <div id="unit-kantor">
      <h3 class="title-4 with-hr">Unit Kantor</h3>
    ...
    <div id="officeInformation">
      <div class="row">
        <div class="col-sm-4">
          <h3 class="title-4">Tempat Terdekat</h3>
          <div class="white-box-sidebar"></div>
        </div>
        <div class="col-sm-8">
          <div class="deskripsiWrap">
            <h3 class="title-4 with-hr">Deskripsi Gedung Kantor</h3>
            <p>
          ...
          <div class="informasiWrap">
            <h3 class="title-4 with-hr">Informasi Lain</h3>
            <p>
              <b>Service Charge</b><br/>
              Typical : IDR 60500<br/>
              Service Charges Description : AC is included in service, Lighting, and Power Outlets are Seperately metered at cost<br/>
              Term of Payment : Quaterly in Advance<br/>
              Security Deposit : 3 Months Base Rent<br/>
              Minimum Lease Term : 2 Years<br/>
              Public Elevator : 10
            </p>
          </div>
          <div class="galleryWrap">
            <h3 class="title-4 with-hr">Galeri Fasilitas Gedung</h3>
            <div class="owl-carousel owl-theme" id="officeGallery">
              <div class="item"><a class="fancybox" href="img/gallery-1.jpg"><div class="img-gallery" style="background: url('img/gallery-1.jpg')"></div></a></div>
              <div class="item"><a class="fancybox" href="img/gallery-2.jpg"><div class="img-gallery" style="background: url('img/gallery-2.jpg')"></div></a></div>
              <div class="item"><a class="fancybox" href="img/gallery-3.jpg"><div class="img-gallery" style="background: url('img/gallery-3.jpg')"></div></a></div>
              <div class="item"><a class="fancybox" href="img/gallery-2.jpg"><div class="img-gallery" style="background: url('img/gallery-2.jpg')"></div></a></div>
              <div class="item"><a class="fancybox" href="img/gallery-3.jpg"><div class="img-gallery" style="background: url('img/gallery-3.jpg')"></div></a></div>
            </div>
          </div>
    ...
    <div id="officeSimilar">
        ...
        <div class="row">
          <div class="col-sm-3 col-xs-6 text-center">
            <a href="#">
              <div class="item-officeSimilar" style="background: url('img/alianz-tower.jpg');">
          ...
          <div class="col-sm-3 col-xs-6 text-center">
            <a href="#">
              <div class="item-officeSimilar" style="background: url('img/dea-tower.jpg');">
                <div class="bg-lens-black">
          ...
          <div class="col-sm-3 col-xs-6 text-center">
            <a href="#">
              <div class="item-officeSimilar" style="background: url('img/menara-prima.jpg');">
                <div class="bg-lens-black">
          ...
          <div class="col-sm-3 col-xs-6 text-center">
            <a href="#">
              <div class="item-officeSimilar" style="background: url('img/nobel-house.jpg');">
                <div class="bg-lens-black">
